...
<div class="formcard3">
		<h3 align="center">TABEL KELAS</h3>
	<a href="tambah_kelas.php"><input type="button" value="Tambah"></a>
	<table class="tabel">
		<tr>
			<th><h3>NO</h3></th>
			<th><h3>ID KELAS</h3></th>
			<th><h3>NAMA KELAS</h3></th>
			<th></th>
		</tr>
<?php
 $no=1;
...
?>
		<tr align="center">
			...
			<td><?php echo "$data[nama_kelas]" ;?><hr></td>

			<td><a href="edit_kelas.php?id_kelas=<?php echo $data['id_kelas'];?>"><input type="button" value="edit"></a><hr></td>
			<td><a href="hapus_kelas.php?id_kelas=<?php echo $data['id_kelas'];?>"><input type="button" value="hapus"></a><hr></td>
			<?php $no++;
		}
		?>
		</tr>
