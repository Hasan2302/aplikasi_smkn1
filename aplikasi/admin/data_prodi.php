...
<div class="formcard3">
		<h3 align="center">TABEL PRODI</h3>
	<a href="tambah_prodi.php"><input type="button" value="Tambah"></a>
	<table class="tabel">
		<tr>
			<th><h3>NO</h3></th>
			<th><h3>ID PRODI</h3></th>
			<th><h3>NAMA PRODI</h3></th>
			<th></th>
		</tr>
<?php
 $no=1;
...
?>
		<tr align="center">
			...
			<td><?php echo "$data[nama_prodi]" ;?><hr></td>

			<td><a href="edit_prodi.php?id_prodi=<?php echo $data['id_prodi'];?>"><input type="button" value="edit"></a><hr></td>
			<td><a href="hapus_prodi.php?id_prodi=<?php echo $data['id_prodi'];?>"><input type="button" value="hapus"></a><hr></td>
			<?php $no++;
		}
		?>
		</tr>
